    ...
    return (
        <div className={"w-fit h-fit translate-x-[-50%] translate-y-[-50%] absolute top-[50%] left-[50%] flex items-center justify-center flex-col sm:gap-[60px]"}>
            <motion.svg
                ...
                <path fill="none" stroke="#fff" strokeWidth="3" strokeMiterlimit="10"
                ...
                <circle fill="none" stroke="#fff" strokeWidth="3" strokeMiterlimit="10" cx="91.883"
                        cy="98.929"
                        r="24.999"/>
                <circle fill="none" stroke="#fff" strokeWidth="3" strokeMiterlimit="10" cx="91.883"
                        cy="98.929"
                        r="33"/>
                <polyline fill="none" stroke="#fff" strokeWidth="3" strokeMiterlimit="10"
                ...
                <polyline fill="none" stroke="#fff" strokeWidth="3" strokeLinejoin="round"
                          strokeMiterlimit="10" points="98.5,124 98.5,97.5 88.5,97.5 88.5,75"/>
                <polyline fill="none" stroke="#fff" strokeWidth="3" strokeMiterlimit="10"
                ...
                <g className="circles">
                    <circle fill="#232222" stroke="#fff" strokeWidth="3" strokeMiterlimit="10" cx="291.5" cy="265.5"
                            r="37.5">
                        <animate attributeType="xml" attributeName="r" from="27.5" to="37.5" dur="1s"
                                 repeatCount="indefinite"/>
                    </circle>

                    <circle fill="#232222" stroke="#fff" strokeWidth="3" strokeMiterlimit="10" cx="267"
                            cy="310" r="30">
                        <animate attributeType="xml" attributeName="r" from="25" to="30" dur="0.9s"
                                 repeatCount="indefinite"/>
                    </circle>

                    <circle fill="#232222" stroke="#fff" strokeWidth="3" strokeMiterlimit="10" cx="229.5"
                            cy="324.5" r="20">
                        <animate attributeType="xml" attributeName="r" from="15" to="20" dur="0.6s"
                                 repeatCount="indefinite"/>
                    </circle>

                    <circle fill="#232222" stroke="#fff" strokeWidth="3" strokeMiterlimit="10" cx="335.5"
                            cy="277.5" r="20">
                        <animate attributeType="xml" attributeName="r" from="15" to="20" dur="0.7s"
                                 repeatCount="indefinite"/>
                    </circle>

                    <circle fill="#232222" stroke="#fff" strokeWidth="3" strokeMiterlimit="10" cx="306.5"
                            cy="224.5" r="22.5">
                        <animate attributeType="xml" attributeName="r" from="11" to="22.5" dur="0.8s"
                                 repeatCount="indefinite"/>
                    </circle>

                    <circle fill="#232222" stroke="#fff" strokeWidth="3" strokeMiterlimit="10" cx="330.5"
                            cy="332.5" r="10">
                        <animate attributeType="xml" attributeName="r" from="5" to="10" dur="0.7s"
                                 repeatCount="indefinite"/>
                    </circle>

                    <circle fill="#232222" stroke="#fff" strokeWidth="3" strokeMiterlimit="10" cx="175.5"
                            cy="291.5" r="10">
                        <animate attributeType="xml" attributeName="r" from="5" to="10" dur="0.5s"
                                 repeatCount="indefinite"/>
                    </circle>

                    <circle fill="#232222" stroke="#fff" strokeWidth="3" strokeMiterlimit="10" cx="270.5"
                            cy="177.5" r="10">
                        <animate attributeType="xml" attributeName="r" from="5" to="10" dur="0.7s"
                                 repeatCount="indefinite"/>
                    </circle>
